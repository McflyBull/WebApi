...
export class TestMigration1732947583007 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE \`film\` DROP COLUMN \`vote_average\``);
    await queryRunner.query(`ALTER TABLE \`film\` ADD \`vote_average\` float NOT NULL`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`film\` DROP COLUMN \`vote_average\``);
    await queryRunner.query(`ALTER TABLE \`film\` ADD \`vote_average\` int NOT NULL`);
  }
}
